% Run_check_plot
% Script used to plot and save results from Run_check script.
% P. Silveira, Sep. 2015
% BSX Proprietary
...
legend(leds, 'Location', 'SouthWest')
ax(2) = subplot(2,1,2);
...
set(gcf, 'Position', [0        -139         876        1007]);
ax(1) = subplot(3,1,1);
plot(sweep.time, sweep.cHbO2_27mm)
grid; axis tight
xlabel('time (s)','FontSize', FONTSIZE)
ylabel('[HbO2]','FontSize', FONTSIZE)
title('Device calculations - 27mm','FontSize', FONTSIZE)
ax(2) = subplot(3,1,2);
plot(sweep.time, sweep.cHhb_27mm)
grid; axis tight
xlabel('time (s)','FontSize', FONTSIZE)
ylabel('[HHb]','FontSize', FONTSIZE)
ax(3) = subplot(3,1,3);
plot(sweep.time, sweep.SmO2_27)
grid; axis tight
%axis ([sweep.time(1) sweep.time(end) 20 100])
xlabel('time (s)','FontSize', FONTSIZE)
ylabel('% Saturation','FontSize', FONTSIZE)
...
% set(gcf, 'Position', [0        -139         876        1007]);
% subplot(3,1,1)
% plot(sweep.time, process.cHb15(:,2))  % oxy
% grid; axis tight
% xlabel('time (s)','FontSize', FONTSIZE)
% ylabel('[HbO2]','FontSize', FONTSIZE)
% title('Direct calculation - 15mm','FontSize', FONTSIZE)
% subplot(3,1,2)
% plot(sweep.time, process.cHb15(:,1))  % deoxy
% grid; axis tight
% xlabel('time (s)','FontSize', FONTSIZE)
% ylabel('[HHb]','FontSize', FONTSIZE)
% subplot(3,1,3)
% plot(sweep.time, process.SmO2_15)
% grid; axis tight
% %axis ([sweep.time(1) sweep.time(end) 20 100])
% xlabel('time (s)','FontSize', FONTSIZE)
% ylabel('% Saturation','FontSize', FONTSIZE)
...
% set(gcf, 'Position', [0        -139         876        1007]);
% subplot(3,1,1)
% plot(sweep.time, process.cHb27(:,2))  % oxy
% grid; axis tight
% xlabel('time (s)','FontSize', FONTSIZE)
% ylabel('[HbO2]','FontSize', FONTSIZE)
% title('Direct calculation - 27mm','FontSize', FONTSIZE)
% subplot(3,1,2)
% plot(sweep.time, process.cHb27(:,1))  % deoxy
% grid; axis tight
% xlabel('time (s)','FontSize', FONTSIZE)
% ylabel('[HHb]','FontSize', FONTSIZE)
% subplot(3,1,3)
% plot(sweep.time, process.SmO2_27)
% grid; axis tight
% %axis ([sweep.time(1) sweep.time(end) 20 100])
% xlabel('time (s)','FontSize', FONTSIZE)
% ylabel('% Saturation','FontSize', FONTSIZE)
...
hold on
plot(sweep.time, process.pH2O_cos,'r')
plot(sweep.time, process.pH2O_proj,'b')
axis tight
grid
legend('pInv', 'No-Hb cos', 'No-Hb proj', 'Location', 'Best')
ax(2) = subplot(3,1,2);
plot(sweep.time, process.HbF, 'k')
xlabel('time (s)','FontSize', FONTSIZE)
ylabel('Hemoglobin Index','FontSize', FONTSIZE)
axis tight
grid
ax(3) = subplot(3,1,3);
plot(sweep.time, process.HbConc, 'k')
xlabel('time (s)','FontSize', FONTSIZE)
ylabel('HbConc','FontSize', FONTSIZE)
axis tight
grid
linkaxes([ax(1) ax(2) ax(3)], 'x');  % zoom in time together
...
% grid
% axis tight %axis([0 sweep.time(end) 20 100])
% ax(2) = subplot(2,1,2);
% plot(sweep.time, sweep.tHb_15,'r')
% hold on
% %plot(sweep.time,tHb_15, 'g')
% xlabel('time (s)','FontSize', FONTSIZE)
% ylabel('[tHb]','FontSize', FONTSIZE)
% plot(sweep.time, sweep.tHb_27,'b')
% %plot(sweep.time,tHb_27, 'k')
