% Script used to perform search for best 5 wavelength multiple regression 
...
switch (LED_list(ii))
    ...
    case 7
        ...
        Xi_sub = Xi(:,LED_list);
        xx1 = Xi_sub(:,1)./(Xi_sub(:,4)-Xi_sub(:,5));
        xx2 = Xi_sub(:,2)./(Xi_sub(:,4)-Xi_sub(:,5));
        xx3 = Xi_sub(:,3)./(Xi_sub(:,4)-Xi_sub(:,5));
        XXi = [xx1 xx2 xx3];
...
switch (LED_list(ii))
    ...
    text(50,30,['W= ' num2str(b(1),'%4.1f') ' + (' num2str(b(2),'%4.1f') ' OD_\lambda_1 ' ...
        num2str(b(3),'%4.1f') ' OD_\lambda_2)/ (OD_\lambda_4 - OD_\lambda_5)'...
        num2str(b(4),'%4.1f') ' OD_\lambda_3)/ (OD_\lambda_4 - OD_\lambda_5)'])
