% Script used to plot a model tissue transflectance spectrum.
...
mean_fract_dry_lipid = 0.28;
std_fract_dry_lipid = 0.05;
...
text(900,7.5,['Water ' num2str(min_pct_wat) ': ' num2str(max_pct_wat) '%'],'FontSize',12)
text(900,7.25,['Bld avg +/- std = ' num2str(mean_pct_bld) '+/- ' num2str(std_pct_bld) '%'],'FontSize',12)
