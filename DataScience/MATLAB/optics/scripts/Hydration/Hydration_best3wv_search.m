...
% best weights for prediction of tissue water fraction 
...
std_pct_bld = 2; %Estimated physiol std is 1%
...
for Wave1_index = 1:60:500,
    for Wave2_index = 21:60:500,
        for Wave3_index = 41:60:500,
        ...
        if rms_error < best_rms_error
            ...
            best_Wave2_index = Wave2_index; best_Wave3_index = Wave3_index;
            best_y_pred = y_pred; best_y = y;best_b = b;
        end
    end
end
end
...
Wave3 = WL_START+ (best_Wave3_index - 1)*WL_STEP;
