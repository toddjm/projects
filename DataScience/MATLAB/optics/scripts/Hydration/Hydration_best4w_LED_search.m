...
% for prediction of tissue water fraction with LED sources
...
for LEDindx1 = [1],          %Choose indices of LED wavelengths to search exhaustively
    for LEDindx2 = [2],
        for LEDindx3 = [3],
            for LEDindx4 = [4],
...
switch (LED_list(ii))
    ...
    case 7
        ...
        for i = 1:no_spectra,
            ...
            %mu_s = (mean_scat_coeff_at_800+std_scat_coeff_at_800*randn)*(wl/800).^(-0.5);  
        ...
        rms_error = mean(abs(y_pred'-y));
            ...
            if rms_error < best_rms_error %Store coeffs with lowest RMSE 
