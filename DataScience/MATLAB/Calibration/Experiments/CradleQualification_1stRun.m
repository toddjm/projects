...
DATE_START = '2015-03-21 08:00:00'; % start date to include in query
DATE_END = '2015-03-21 20:40:00';   % end date to include in query
...
for jj = numel(device.checkouts):-1:1;  % check all available checkouts
