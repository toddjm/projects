...
DATE_START = '2015-03-24 00:00:00'; % start date to include in query
DATE_END = '2015-03-24 23:59:00';   % end date to include in query
...
device = getDevice('', 'status', '0', 'dateStart', DATE_START, 'dateEnd', DATE_END)
for jj = numel(device.checkouts):-1:1;  % check checkouts in the order they were entered (inverse numeric order)
...
disp(['Station: ' device.checkouts{1}.station ' . Block: ' device.checkouts{1}.block])
