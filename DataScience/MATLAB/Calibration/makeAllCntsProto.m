...
%the AllCnts (Counts_0) matrix. Modified to work with Nellie and Calypso
%prototypes. Requires the
clear all;
close all;

USERPATH = getenv('USERPROFILE');
CALIB_PATH = [USERPATH '\Google Drive\Tech_RD\Sensor\Research\Testing\Heart rate\Nellie Wrist\'];

filename = uigetfile('*Calib*AllOpen*.csv', 'Select calibration sweep file', 'MultiSelect', 'off');
...
pb432Cal = struct('Ua',[0.08 0.102 0.0789],'wavelengths',[805 680 850],'Usp',[9.52 10.1 9.36]);
