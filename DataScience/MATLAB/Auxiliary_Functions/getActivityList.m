function [ AssessmentList, assessmentStruc ] = getActivityList( varargin )
% function [ AssessmentList, assessmentStruc ] = getActivityList( varargin )
...
%
% Nithin Rajan and P. Silveira, April. 2015
% BSX Proprietary

assessmentPages = getActivities(varargin{:});
numPages = 1+assessmentPages.last_page-assessmentPages.current_page;
k=0;
for j=1:numPages
    Assessments = getActivities(varargin{:}, 'page', num2str(j));
