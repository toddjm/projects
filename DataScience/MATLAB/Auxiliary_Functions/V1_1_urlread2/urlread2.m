...
% The following lines have been commented out to allow this function to
% work on Byron's desktop due to a difference in java libraries.
% mwtcp = com.mathworks.net.transport.MWTransportClientPropertiesFactory.create();
% proxy = mwtcp.getProxy();
% 
% % Open a connection to the URL.
% if isempty(proxy)
     urlConnection = url.openConnection; % do not comment out
% else
