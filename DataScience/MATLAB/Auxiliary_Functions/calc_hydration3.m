function [ pH2O, Pk2, Resid2, mu_eff, mu_s, mu_a ] = calc_hydration3( ODDiff, MU, BODY_PART  )
% [ pH2O, Pk, Resid, mu_eff, mu_s, mu_a ] = calc_hydration3( ODDiff, MU, BODY_PART  )
% Calculates raw hydration values from difference in optical densitities.
% Includes collagen and lipid, and tries to exclude Hb contribution.
%
% Example
...
% pH2O = calc_hydration3(OD27-OD15);
%
% Inputs
...
fMat3 = 1.0e+02 * [  3.053960000000000   0.771857642611746   0.691760000000000   0.752280000000000
